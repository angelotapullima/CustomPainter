...
class SlidersPainter extends StatefulWidget {
  const SlidersPainter({super.key});

  @override
  State<SlidersPainter> createState() => _SlidersPainterState();
}

class _SlidersPainterState extends State<SlidersPainter> {
  var _sides = 3.0;
  var _radius = 100.0;
  var _radians = 0.0;
